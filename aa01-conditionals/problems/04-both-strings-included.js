...
2. It needs to accept a sentence string and two additional strings. 3 parameters total.
...
function bothStringsIncluded (fullSentence, word1, word2) {
    if (fullSentence.includes(word1) && fullSentence.includes(word2))
        {
            return true;
        } else {
            return false;
